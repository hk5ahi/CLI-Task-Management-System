...
public class CustomTaskDaoImpl implements CustomTaskDao {
    ...
    public List<Task> filterTasksByQueryParameters(QueryParameterDTO queryParams,String header) {
        ...
        if (loggedInUser.getUserRole().equals(User.UserRole.Supervisor) && (requestedUser!=null && requestedUser.getUserRole().equals(User.UserRole.Manager)) ) {
            jpql.append(" AND t.createdBy = :createdBy");
        }
        ...
        {
            jpql.append(" AND t.taskStatus = :task_status AND t.createdBy = :createdBy");
        }
        ...
        {
            jpql.append(" AND t.assignee = :assignee AND t.createdBy = :createdBy");
        }
        ...
        {
            jpql.append(" AND t.assignee = :assignee AND t.createdBy = :createdBy AND t.taskStatus = :task_status");
        }
        ...
        if (authUserDTO.getUserRole().equals(User.UserRole.Supervisor) && (requestedUser!=null && requestedUser.getUserRole().equals(User.UserRole.Manager)) ) {
            query.setParameter("createdBy", requestedUser);
        }
        if (queryParams.getTaskStatus()!=null && loggedInUser.getUserRole().equals(User.UserRole.Supervisor)) {
        ...
        if(loggedInUser.getUserRole().equals(User.UserRole.Employee) && queryParams.getTaskStatus()!=null && queryParams.getUserName()==null)
        {
